#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Ferramenta para cadastrar credenciais do Instagram no keyring.

Além das senhas tradicionais, agora é possível registrar também o
``sessionid`` de cada conta. O uso de ``sessionid`` reduz desafios de
login em ambientes headless e facilita automações.
...
def set_cred(
    ...
    """Salva a credencial ``secret`` no keyring."""
    ...
    print(f"🔒 Credencial armazenada para: {username}{sufix}")
